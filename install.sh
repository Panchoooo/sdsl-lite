...
cmake -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_INSTALL_PREFIX="${SDSL_INSTALL_PREFIX}" -DCMAKE_CXX_COMPILER="/usr/bin/gcc-7".. # run cmake 
if [ $? != 0 ]; then
...
echo "g++ -std=c++14 -DNDEBUG -O3 [-msse4.2] \\"
